<x-layout>
    <div class="container py-md-5 container--narrow">
      <h2>
        ...
        @if (!$currentlyFollowing AND auth()->user()->username != $username) {{-- checks if not currently following and not looking at your own profile --}}
        ...
        @if(auth()->user()->username == $username) {{-- if looking at user's own profile, change avatar button appears --}}
